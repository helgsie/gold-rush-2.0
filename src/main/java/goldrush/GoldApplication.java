...
public class GoldApplication extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        Font.loadFont(Objects.requireNonNull(getClass().getResource("/goldrush/letur/PixeloidSans.ttf")).toExternalForm(), 12);
        Font.loadFont(Objects.requireNonNull(getClass().getResource("/goldrush/letur/PixeloidSans-Bold.ttf")).toExternalForm(), 16);
        String myStyles = """
                         .button, .texti, .label {
